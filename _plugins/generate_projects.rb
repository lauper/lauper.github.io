...
module Jekyll
  ...
  class ProjectIndex < Page
    ...
    def initialize(site, base_dir, project_dir, project_name)
      @site = site
      @base = base_dir
      @dir  = project_dir
  ...
  class Site
    ...
    def write_project_indexes
      ...
      projects = Github.repos.list user: 'lauper'
      projects.each do |project_name|
        self.write_project_index(File.join(base_dir, project_name), project_name)
      end
    end
    ...
    #  +project_name+        is the name of the project to process.
    def write_project_index(project_dir, project_name)
      index = ProjectIndex.new(self, self.source, project_dir, project_name)
